                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="zipcode" type="number" class="form-control{{ $errors->has('zipcode') ? ' is-invalid' : '' }}" name="zipcode" value="{{ old('zipcode') }}" required autofocus>
                        ...
                        <div class="form-group">
                            <label class="custom-file">
                                <input type="file" id="avatar" class="custom-file-input{{ $errors->has('avatar_file') ? ' is-invalid' : '' }}" name="avatar_file">
